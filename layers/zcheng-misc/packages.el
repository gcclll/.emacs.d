;;; packages.el --- zcheng-misc layer packages file for Spacemacs.
;;
...
;; added to `zcheng-misc-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `zcheng-misc/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `zcheng-misc/pre-init-PACKAGE' and/or
;;   `zcheng-misc/post-init-PACKAGE' to customize the package as it is loaded.
...
(defun zcheng-misc/init-lispyville ()
...
(defun zcheng-misc/post-init-symbol-overlay ()
...
(defun zcheng-misc/init-highlight-global ()
...
(defun zcheng-misc/post-init-golden-ratio ()
...
(defun zcheng-misc/post-init-ranger ()
...
(defun zcheng-misc/post-init-smartparens ()
...
(defun zcheng-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun zcheng-misc/post-init-avy ()
  (progn
...
(defun zcheng-misc/post-init-evil ()
  (progn
...
(defun zcheng-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun zcheng-misc/init-visual-regexp-steroids ()
...
(defun zcheng-misc/init-find-file-in-project ()
