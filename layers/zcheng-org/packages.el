;;; packages.el --- zcheng-org layer packages file for Spacemacs.
;;
...
;; added to `zcheng-org-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `zcheng-org/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `zcheng-org/pre-init-PACKAGE' and/or
;;   `zcheng-org/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst zcheng-org-packages
  '(
...
(defun zcheng-org/post-init-org-superstar ()
  (progn
    (setq org-superstar-headline-bullets-list '("☰" "☷" "☯" "☭"))))

(defun zcheng-org/post-init-evil-org ()
...
(defun zcheng-org/init-org-mac-link ()
...
(defun zcheng-org/post-init-ox-reveal ()
  (setq org-reveal-root "file:///Users/simon/.spacemacs.d/reveal-js"))

(defun zcheng-org/init-org-tree-slide ()
  (use-package org-tree-slide
    :init
    (spacemacs/set-leader-keys "oto" 'org-tree-slide-mode)))

(defun zcheng-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun zcheng-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/org-notes")))

(defun zcheng-org/init-ob-typescript ()
  (use-package ob-typescript
    :init))

(defun zcheng-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun zcheng-org/post-init-deft ()
  (progn
...
(defun zcheng-org/init-sound-wav ()
